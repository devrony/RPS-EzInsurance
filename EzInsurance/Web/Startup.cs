...
using AppPermissions = EzInsurance.DAL.Core.ApplicationPermissions;
using AspNet.Security.OpenIdConnect.Primitives;
using OpenIddict.Core;

namespace EzInsurance.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["Data:DefaultConnection:ConnectionString"], b => b.MigrationsAssembly("EzInsurance.Web"));
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy(AuthPolicies.ManagePoliciesPolicy, policy => policy.RequireClaim(CustomClaimTypes.Permission, AppPermissions.ManagePolicies));
            });
